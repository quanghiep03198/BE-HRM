...
export class EmployeeEntity extends BaseAbstractEntity {
	...
	@Column({
		...
		nullable: true,
		comment:
			'Loại hợp đồng: indefinite_term, fixed_term, seasonal, internship, probationary, part_time, apprenticeship'
	})
	...
	user?: any // Will be properly typed after importing UserEntity
