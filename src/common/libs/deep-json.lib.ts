...
export class DeepJson {
	...
	/**
	 * Check if value contains nested JSON strings
	...
	/**
	 * Parse all nested JSON strings to JavaScript objects
	...
	/**
	 * Stringify all nested objects/arrays (except primitives)
